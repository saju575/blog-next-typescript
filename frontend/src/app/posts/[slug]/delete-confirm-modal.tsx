...
const DeleteConfirmModal: React.FC<ModalProps> = ({
  isOpen,
  onClose,
  onExecute,
}) => {
          ...
          <div className="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
            ...
            <div className="p-6 pt-0 text-center">
              ...
              <span
                ...
                className="text-dark bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center px-3 py-2.5 text-center mr-2 border border-gray-200 cursor-pointer"
              >
                Yes, I&apos;m sure
              </span>
              <span
